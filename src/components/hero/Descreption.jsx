...
function Descreption() {
  ...
  return (
    <Box color="primary.light" >
      {isLoading ? <Loader /> : (<Typography sx={{ fontWeight: "600", fontSize: "32px" }}>Hi I'am  <span style={{ color: "#FFDF39" }}>{contacts[0]?.fullName} a web dev</span>.. specialiste in <span style={{ color: "#FFDF39" }}>MERN</span>  stack;</Typography>
      )}
