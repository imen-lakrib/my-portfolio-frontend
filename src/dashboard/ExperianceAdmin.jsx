...
export default function ExperianceAdmin() {
    useEffect(() => {
        getExperiances()
    }, [])
// get all experiments
    ...
    const emptyRows = page > 0 ? Math.max(0, (1 + page) * rowsPerPage - experiances.length) : 0;
                    ...
                    <Grid Grid container spacing={2}>
                        ...
                        <Container>
                            <Box sx={{ m: 1  }}>
                                ...
                                <TableContainer>
                                    <Table size='small'>
                                        ...
                                        <TableBody>
                                            ...
                                            {!loading && experiances.length === 0 && !connectionErr && (
                                ...
                                {!loading && !connectionErr && experiances.length > 0 &&
                                    <TablePagination
            ...
            <Dialog
                ...
                <DialogContent sx={{ padding: "20px 40px" }}>
                    ...
                    <TextField id="outlined-basic" label="start at" variant="outlined" value={start}
                            ...
                            fullWidth sx={{ margin: "20px 0" }} />
                             <TextField id="outlined-basic" label="company" variant="outlined" value={company}
                            onChange={(e) => {
